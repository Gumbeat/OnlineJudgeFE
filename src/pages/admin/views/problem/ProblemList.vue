<template>
  <div class="view">
    <Panel :title="contestId ? 'Список задач соревнования' : 'Список задач'">
      ...
      <el-table
        ...
        <el-table-column
          ...
          <div slot-scope="scope">
            ...
            <icon-btn v-if="contestId" name="Показать" icon="clone"
      ...
      <div class="panel-options">
        ...
        <el-button v-if="contestId" type="primary"
                   ...
                   @click="addProblemDialogVisible = true">Добавить из имеющихся
        </el-button>
        <el-pagination
          class="page"
    ...
    <el-dialog title="Добавить задачу для соревнования"
               v-if="contestId"
               width="80%"
