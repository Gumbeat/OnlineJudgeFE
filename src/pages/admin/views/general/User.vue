  ...
  <div class="view">
    <Panel :title="$t('m.User_User') ">
      ...
      <el-table
        ...
        <el-table-column prop="last_login" label="Паследняя авторизация">
          <template slot-scope="scope">
        ...
        <el-table-column fixed="right" label="Действие" width="200">
          ...
          <el-col :span="12">
            <el-form-item :label="$t('m.Problem_Permission')">
              <el-select v-model="user.problem_permission" :disabled="user.admin_type!=='Admin'">
                <el-option label="Отсутствуют" value="None"></el-option>
