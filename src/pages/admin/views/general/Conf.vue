  ...
  <div class="view">
    <Panel :title="$t('m.SMTP_Config')">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item :label="$t('m.Port')" required>
              <el-input type="number" v-model="smtp.port" placeholder="Порт сервера SMTPt"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item :label="$t('m.Email')" required>
              <el-input v-model="smtp.email" placeholder="Почтовый аккаунт для отправки сообщения"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
      ...
      <el-button type="warning" @click="testSMTPConfig"
                 v-if="saved" :loading="loadingBtnTest">Отправить пробное письмо</el-button>
    </Panel>
